        ...
        <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                {filteredMaterials.map((mat, i) => (
                    ...
                    >
                        <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:scale-125 transition-transform duration-700 text-slate-500">
                        ...
                        <div className="flex justify-between items-start mb-8 relative">
                            ...
                            <div className="text-[9px] font-bold text-slate-400 uppercase tracking-[0.3em] bg-slate-100 px-3 py-1 rounded-full border border-slate-200">
                                {mat.component_type}
                            </div>
                        </div>

                        <h4 className="text-xl font-bold text-slate-800 mb-6 group-hover:text-primary transition-colors duration-500">{mat.name}</h4>
                        ...
                        <div className="mt-8 pt-8 border-t border-slate-200 flex justify-between items-center group/btn">
                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Property Matrix</span>
                            {mat.source_url && (
                                <a href={mat.source_url} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center hover:border-primary/40 hover:bg-primary/5 transition-all bg-white shadow-sm">
